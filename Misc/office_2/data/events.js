...
var exportedMethods = {
    ...
    getEvent: (id) => {
        ...
        var event = eventList.filter(x => x.id === id).shift();
        //console.log(event);
    ...
    getEventsForAttendee: (attendeeId) => {
        //console.log(attendeeId + " attendee ID In db")
    ...
    getEventsForLocation: (locationId) => {
        //console.log(locationId + " locationId ID In db")
        if (locationId === undefined) return Promise.reject("No attendee id provided");
